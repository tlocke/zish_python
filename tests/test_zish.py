...
@pytest.mark.parametrize(
    "zish_str,pyth", [
        ...
        (
            '2007-01-01',
            ZishLocationException(
                1, 12, 'The value 2007-01-01 is not recognized.')
        ),
        ...
        (
            '2007-01-01T',
            ZishLocationException(
                1, 13, 'The timestamp 2007-01-01T is malformed.')
        ),
        ...
        (
            '2007-01T',
            ZishLocationException(
                1, 10, 'The timestamp 2007-01T is malformed.')
        ),
        ...
        (
            '2007T',
            ZishLocationException(1, 7, 'The timestamp 2007T is malformed.')
        ),
        ...
        (
            '2007-02-23',
            ZishLocationException(
                1, 12, 'The value 2007-02-23 is not recognized.')
        ),
        ...
        (
            '0xBeef',
            ZishLocationException(1, 8, 'The value 0xBeef is not recognized.')
        ),

        # Error: An int can't be denoted in binary
        (
            '0b0101',
            ZishLocationException(1, 8, 'The value 0b0101 is not recognized.')
        ),

        # Error: An int can't have underscores
        (
            '1_2_3',
            ZishLocationException(1, 7, 'The value 1_2_3 is not recognized.')
        ),
        ...
        (
            '0b10_10_10',
            ZishLocationException(
                1, 12, 'The value 0b10_10_10 is not recognized.')
        ),

        # ERROR: leading plus not allowed
        (
            '+1',
            ZishLocationException(1, 4, r'The value \+1 is not recognized.')
        ),

        # ERROR: leading zeros not allowed (no support for octal notation)
        (
            '0123',
            ZishLocationException(1, 6, 'The value 0123 is not recognized.')
        ),

        # ERROR: trailing underscore not allowed
        (
            '1_',
            ZishLocationException(1, 4, 'The value 1_ is not recognized.')
        ),

        # ERROR: consecutive underscores not allowed
        (
            '1__2',
            ZishLocationException(1, 6, 'The value 1__2 is not recognized.')
        ),
        ...
        (
            '0x_12',
            ZishLocationException(1, 7, 'The value 0x_12 is not recognized.')
        ),

        # ERROR: ints cannot start with underscores
        (
            '_1',
            ZishLocationException(1, 4, 'The value _1 is not recognized.')
        ),
        ...
        (
            '0d0',
            ZishLocationException(1, 5, 'The value 0d0 is not recognized.')
        ),
        ...
        (
            '-0d0',
            ZishLocationException(1, 6, 'The value -0d0 is not recognized.')
        ),
        ...
        (
            '123_._456',
            ZishLocationException(
                1, 11, 'The value 123_._456 is not recognized.')
        ),
        ...
        (
            '12__34.56',
            ZishLocationException(
                1, 11, 'The value 12__34.56 is not recognized.')
        ),
        ...
        (
            '123.456_',
            ZishLocationException(
                1, 10, 'The value 123.456_ is not recognized.')
        ),
        ...
        (
            '-_123.456',
            ZishLocationException(
                1, 11, 'The value -_123.456 is not recognized.')
        ),
        ...
        (
            '_123.456',
            ZishLocationException(
                1, 10, 'The value _123.456 is not recognized.')
        ),
        ...
        (
            '("hello world!")',
            ZishLocationException(
                1, 9, r'The value \("hello is not recognized.')
        ),
...
'""",
        ...
        (
            '{',
            ZishLocationException(
                1, 2, r"After this opening '\{', a key or a closing '\}' was "
        ...
        (
            '{ x:1, }',
            ZishLocationException(1, 5, "The value x is not recognized.")
        ),
        ...
        (
            '{ "x":1, "x":null }',
            ZishLocationException(
                1, 19, "Duplicate map keys aren't allowed: 'x'")
        ),
        ...
        (
            '{ "x": 1 4 }',
            ZishLocationException(
                1, 12, r"Expected a ',' or a '\}' here, but got '4'")
        ),
        ...
        (
            '[ 1.2, ]',
            ZishLocationException(
                1, 9, "Trailing commas aren't allowed in Zish.")
        ),
        ...
        (
            '{:: 1}',
            ZishLocationException(1, 3, "The token type 2 isn't recognized.")
        ),
